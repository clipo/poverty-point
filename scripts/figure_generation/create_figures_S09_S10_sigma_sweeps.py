...
def main():
    ...
    fig2.savefig(OUTPUT_DIR / 'figure_S09_sigma_vs_aggregation.png', dpi=300, bbox_inches='tight')
    fig2.savefig(OUTPUT_DIR / 'figure_S09_sigma_vs_aggregation.pdf', bbox_inches='tight')
    plt.close(fig2)
    ...
    fig3.savefig(OUTPUT_DIR / 'figure_S10_sigma_vs_cost.png', dpi=300, bbox_inches='tight')
    fig3.savefig(OUTPUT_DIR / 'figure_S10_sigma_vs_cost.pdf', bbox_inches='tight')
    plt.close(fig3)
